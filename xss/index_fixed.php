...
<div>Content: </div>
<div>
    <textarea type="text" name="content" cols="50" rows="20"><?php echo htmlentities($content); ?></textarea>
</div>
...
<div><a href="<?php echo htmlentities($id); ?>"><?php echo htmlentities($id); ?></a></div>

<?php

$a = htmlentities('javascript:alert("1")', ENT_QUOTES, 'UTF-8', false);
echo '<a href="' . $a . '">link</a>';
echo '<br />';
//echo htmlspecialchars("'", ENT_HTML401);
echo urldecode('http://id.fpt.vn/oauth/google2?state=client_id%253D1001%2526redirect_uri%253Dhttp%253A%252F%252Fexample.com&code=4/qD9P');
?>
https://id.fpt.vn/oauth/google2?state=&client_id=1001&redirect_uri=http://example.com
